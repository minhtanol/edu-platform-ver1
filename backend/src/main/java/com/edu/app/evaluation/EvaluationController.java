...
public class EvaluationController {
  ...
  @GetMapping("/student/{studentId}") public ApiResponse<Page<EvaluationDtos.EvaluationResponse>> byStudent(Authentication auth, @PathVariable UUID studentId, @RequestParam(defaultValue="0") int page) { return ApiResponse.ok(service.byStudent(auth.getName(), studentId, PageRequest.of(page, 20))); }
