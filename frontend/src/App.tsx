...
import { DashboardStats, UsersPage, ApprovalsPage, ReportsPage } from './pages/admin/AdminPages';
...
export function App() {
  return <Routes>
    ...
    <Route element={<Private />}>
      <Route path="/admin" element={<DashboardStats />} /><Route path="/admin/users" element={<UsersPage />} /><Route path="/admin/approvals" element={<ApprovalsPage />} /><Route path="/admin/reports" element={<ReportsPage />} />
